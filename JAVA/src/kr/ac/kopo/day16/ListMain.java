...
//		List<String> list = new ArrayList<String>(); // <참조자료형>
		List<String> list = new LinkedList<String>(); // <참조자료형>
		...
		System.out.println("< 1.5버전의 fot문 전체 데이터 출력 >");
		for (String str : list) {
