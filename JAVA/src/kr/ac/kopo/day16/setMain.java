...
public class setMain {
	...
	public static void main(String[] args) {
		...
		set.add("four");
		set.add("five");
		System.out.println("add(two) : " + set.add("two")); // 중복을 허용하지 않음
		...
		/*
		 * Set 전체데이터 접근 방식 1. 1.5버전의 for문 이용, 2. toArray() 메소드 이용, 3. Iterator객체 이용
		 * Iterator객체(순환자) : 맨 처음 데이터부터 맨 마지막 데이터까지 접근
		 */
